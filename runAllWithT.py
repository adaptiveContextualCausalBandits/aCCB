...
def run_multiple_sims_multiple_models_stochastic(models, num_sims, exploration_budget, num_intermediate_contexts,
                                      num_interventions, diff_prob_transition, default_reward, diff_in_best_reward):
    total_regret = np.zeros((len(models)), dtype=np.float32)
...
if __name__ == "__main__":
    ...
    exploration_budgets = [250, 500, 1000, 2500, 5000, 7500, 10000, 12500, 15000, 20000, 25000, 50000, 100000, 250000,
                           500000, 1_000_000, 5_000_000, 10_000_000]
