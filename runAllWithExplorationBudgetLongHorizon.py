...
if __name__ == "__main__":
    ...
    for regret_metric_name in ["simple_regret", "prob_best_intervention"]:
        for stochastic_flag in [True, False]:
            ...
            if stochastic_flag:
                file_path = "outputs/" + regret_metric_name + "_with_" + "exploration_budget_long_horizon.txt"
            else:
                file_path = "outputs/" + regret_metric_name + "_with_" + "exploration_budget_long_horizon_deterministic.txt"
